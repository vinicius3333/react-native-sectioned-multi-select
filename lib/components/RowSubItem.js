...
const shouldNotRerender = (prevProps, nextProps) => {
  ...
  */
 const { selectedItems, subItem, childItemId, highlightedChildren, parentsHighlightChildren } = prevProps;
 if (nextProps.selectedItems !== prevProps.selectedItems) {

  if (selectedItems.includes(childItemId(subItem)) &&
...
const RowSubItem = React.memo((props) => {
  ...
  const renderSelectedIcon = () => {
    ...
    const itemHighlighted = !parentsToggleChildren && highlightedChildren.includes(childItemId(subItem))
    console.log('itemHighlighted', itemHighlighted);
    
    return itemSelected || itemHighlighted ? <SelectedIcon highlighted={itemHighlighted}/> : <UnselectedIcon />
  }
  ...
  getStyles('subItemTextContainer',
  { 
    itemSelected,
    subItem,
