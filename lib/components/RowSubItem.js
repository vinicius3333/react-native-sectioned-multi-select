...
class RowSubItem extends Component {
  shouldComponentUpdate(nextProps) {
    ...
    if (this.props.parentsHighlightAllChildren) {
      if (this.props.highlightedChildren.includes(this.props.childItemId(this.props.subItem))) {
        console.log('subitem parents select all this', this.props.highlightedChildren);
        
        return true
      }
      if (nextProps.highlightedChildren.includes(this.props.childItemId(this.props.subItem))) {
        console.log('subitem parents select all next', nextProps.highlightedChildren);
  ...
  _renderSelectedIcon = () => {
    ...
    const highlightChild = !parentsSelectAllChildren && highlightedChildren.includes(childItemId(subItem))
