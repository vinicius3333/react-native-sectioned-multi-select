...
import { useSMSContext } from 'react-native-sectioned-multi-select'
import { PARENT_ITEM, CHILD_ITEM } from 'react-native-sectioned-multi-select/lib/reducer/actionOrigins'
...
const RowItem = React.memo(props => {
  ...
  getStyles('dropDownToggleIconWrapper', { isOpen: dropDownIsOpen }, stylesFromProps), 
  [stylesFromProps.dropDownToggleIconWrapper, styles.dropDownToggleIconWrapper, dropDownIsOpen])
    ...
    <View>
      ...
      >
        <TouchableOpacity
          ...
          style={[
            itemStyles,
            itemSelected && selectedItemStyles
          ]}
        >
          ...
          {itemIconPosition === 'left' && iconKey && item[iconKey] && (
            <ItemIcon
              ...
              style={[
                itemIconStyles,
                itemSelected && itemIconSelectedStyles,
              ]}
            />
          )}
          ...
          <Text
            ...
            style={[
              itemTextStyles,
              itemSelected && selectedItemTextStyles,
            ]}
          >
            {item[displayKey]}
          </Text>
          {item.description && <Text style={descriptionTextStyles}>{item.description}</Text>}
          </View>
