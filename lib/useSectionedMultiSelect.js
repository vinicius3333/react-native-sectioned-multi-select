...
export const useSectionedMultiSelect = props => {
  ...
  const components = React.useMemo(() => {
    const c = defaultComponents({ components: getProps.components, iconNames: getProps.iconNames, colors: state.colors, styles: state.styles, iconRenderer: getProps.iconRenderer });
   console.log('ccc', c);
