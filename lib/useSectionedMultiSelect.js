...
import useItemsReducer, { loggerMiddleware, thunkMiddleware } from './reducer/useItemsReducer';
...
export const useSectionedMultiSelect = props => {
  ...
  const components = React.useMemo(() => {
    const c = defaultComponents({ components: getProps.components, iconNames: getProps.iconNames, colors: theme.colors, styles: theme.styles, iconRenderer: getProps.iconRenderer });
  ...
  const _checkIsParent = item => {
    ...
    console.log('checkIs', getChildren(item));
